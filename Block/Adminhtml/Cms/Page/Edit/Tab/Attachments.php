 ...
 */
namespace SY\Attachments\Block\Adminhtml\Cms\Page\Edit\Tab;
...
class Attachments extends \Magento\Backend\Block\Widget\Grid\Extended {
	...
	protected function _prepareColumns(){
		...
		try {
			if($this->getCmsPage()){
				$values = \Zend_Json::decode($this->getCmsPage()->getData('attachments'));
	...
	public function getGridUrl(){
		return $this->getUrl('sy_attachments/cmspage/grid', ['_current' => true]);
	}
}